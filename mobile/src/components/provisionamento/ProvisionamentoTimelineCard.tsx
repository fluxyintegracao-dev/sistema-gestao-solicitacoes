...
import type { ProvisionamentoHistoricoItem } from '../../services/api/types';
import { colors, radii, spacing } from '../../theme';
import { formatDateTimeBR } from '../../utils/format';
import { formatProvisionamentoStatus } from '../../utils/provisionamento';

export function ProvisionamentoTimelineCard({ item }: { item: ProvisionamentoHistoricoItem }) {
  return (
    <View style={styles.card}>
      ...
      {(item.status_anterior || item.status_novo) ? (
        <Text style={styles.meta}>
          Status: {formatProvisionamentoStatus(item.status_anterior)} {'->'} {formatProvisionamentoStatus(item.status_novo)}
        </Text>
      ) : null}
