    ...
    secoes: [
      {
        ...
        itens: [
          ...
          { titulo: 'Compras diretas', descricao: 'Usuarios, credores, itens, obras e volume financeiro das compras diretas.', to: '/compras/relatorios/compras-diretas', status: 'Disponivel', permissao: 'comprasCotacoes', componentKey: 'relatorios.compras.compras_diretas' },
