...
const STATUS_SOLICITACAO_PAGAMENTO_PARCIAL = 'PAGAMENTO PARCIAL';
...
function calcularStatusSolicitacaoPorTitulos(titulos = [], statusAtual = null) {
  ...
  if ([STATUS_SOLICITACAO_PAGA, STATUS_SOLICITACAO_PAGAMENTO_PARCIAL].includes(statusAtualNormalizado)) {
